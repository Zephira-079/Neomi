...
class General(commands.Cog):
    ...
    async def report(self, ctx, *message):
        ...
        report_channel = next(
            (
                ...
                if channel.name in ["report", "reports"]
            ),
            None,
        )
        embed = discord.Embed(
    ...
    async def suggestion(self, ctx, *message):
        ...
        report_channel = next(
            (
                channel
                for channel in text_channels
                if channel.name in ["suggest", "suggestion", "suggestions"]
            ),
            None,
        )
        embed = discord.Embed(
    ...
    async def grayravens(self, ctx):
        embed = discord.Embed(
            title="PGR wiki",
            description=f'Visit at [**https://grayravens.com**] to find more about pgr \n - It includes Guides, Story Summary, Characters, Memories, Items, Interlude, And so on!',
            color=ctx.author.color,
        )
